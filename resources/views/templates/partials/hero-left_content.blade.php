<section class="hero-section" id="home">
    <div class="container position-relative" style="z-index: 1;">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <span class="section-tag mb-3 d-block" style="background: rgba(142, 192, 255, 0.2); width: fit-content; padding: 5px 15px; border-radius: 50px; font-size: 0.8rem; font-weight: 600;">Welcome to Keeper Library</span>
                ...
                <div class="d-flex gap-3">
                    <button class="btn btn-primary px-4 py-3 shadow-lg hero-btn" style="border-radius: 12px; font-weight: 600;">
                        {{ $button ?? 'Explore More' }}
                    </button>
                </div>
            </div>
            <div class="col-lg-6 d-none d-lg-block">
                <div class="hero-img-container" style="border-radius: 30px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.15);">
                    <img
                        src="{{ isset($image) ? asset('storage/' . $image) : asset('images/defaults/landing-default.png') }}"
                        class="hero-bg img-fluid"
                        alt="Hero"
                        id="hero-image-element"
                        style="{{ !isset($image) ? 'display:none;' : 'display:block; width: 100%; height: 500px; object-fit: cover;' }}"
                    >
                    @if(!isset($image))
                        <div id="hero-placeholder-icon" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); height: 500px; display: flex; align-items: center; justify-content: center;">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="p-4 border-0 shadow-sm card-feature" style="background: #fff; border-radius: 20px;">
                    <div class="mb-3 text-primary bg-primary bg-opacity-10 d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; border-radius: 12px;">
            ...
            <div class="col-md-6">
                <div class="p-4 border-0 shadow-sm card-feature" style="background: #fff; border-radius: 20px;">
                    <div class="mb-3 text-success bg-success bg-opacity-10 d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; border-radius: 12px;">
...
<section class="py-5" id="announcement" style="background-color: #f9fafb;">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="#" onclick="loadPage('announcements'); return false;" class="btn btn-outline-primary btn-sm">View All</a>
        </div>
        <div class="announcement-wrapper d-flex gap-4 overflow-auto pb-4" id="announcement-list">
            @isset($news)
                @foreach($news as $item)
                    <div class="announcement-card flex-shrink-0" style="width: 300px; background: #fff; border-radius: 15px; overflow: hidden; shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        <img src="{{ $item->image ? asset('storage/' . $item->image) : asset('images/defaults/image-default.png') }}" style="width: 100%; height: 180px; object-fit: cover;">
                        <div class="p-3">
           ...
           @php
            ...
            @foreach($links as $link)
                <div class="col-lg-4 col-md-6">
                    ...
                    <a href="{{ $url }}" target="_blank" class="text-decoration-none card border-0 shadow-sm p-3 h-100" style="border-radius: 15px; transition: transform 0.2s;">
