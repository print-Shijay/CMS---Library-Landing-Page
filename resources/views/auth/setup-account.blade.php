                        ...
                        <form action="{{ route('account.setup.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="social_media[facebook]" class="form-control"
                                    placeholder="https://facebook.com/..." value="{{ old('social_media.facebook') }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><i class="bi bi-twitter-x"></i> X URL</label>
                                <input type="url" name="social_media[twitter]" class="form-control"
                                    placeholder="https://x.com/..." value="{{ old('social_media.twitter') }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="url" name="social_media[instagram]" class="form-control"
                                    placeholder="https://instagram.com/..." value="{{ old('social_media.instagram') }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><i class="bi bi-github"></i> GitHub URL</label>
                                <input type="url" name="social_media[github]" class="form-control"
                                    placeholder="https://github.com/..." value="{{ old('social_media.github') }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="url" name="social_media[linkedin]" class="form-control"
                                    placeholder="https://linkedin.com/..." value="{{ old('social_media.linkedin') }}">
                            </div>
